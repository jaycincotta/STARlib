...
import { sumArray, indexOfMax } from "../StarResults";
...
test("Prop Test 1", () => {
  ...
  var propWinners = [];
  var winners = results.prop.winners;
  for (i = 0; i < winners.length; i++) {
    propWinners.push(winners[i].name);
  }
  var propSplitPoints = results.prop.debuginfo.splitPoints;
  var propSpentAbove = results.prop.debuginfo.spentAboves;
  var propWeightOnSplits = results.prop.debuginfo.weight_on_splits;
